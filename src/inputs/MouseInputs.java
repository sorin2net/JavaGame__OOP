...
/**
 * Clasa ce gestioneaza input-uri pentru mouse
 */
public class MouseInputs implements MouseListener, MouseMotionListener {
	...
	public void mouseMoved(MouseEvent e) {
		...
		case MENU:
			...
			break;
			case SCORES:
				gamePanel.getGame().getScores().mouseMoved(e);
				break;
		case PLAYING:
	...
	public void mousePressed(MouseEvent e) {
		...
		case PLAYING:
			...
			case OPTIONS:
				...
				break;
			case SCORES:
				gamePanel.getGame().getScores().mousePressed(e);
				break;
		default:
			break;
	...
	public void mouseReleased(MouseEvent e) {
		...
		case PLAYING:
			...
			case OPTIONS:
				...
				break;
			case SCORES:
				gamePanel.getGame().getScores().mouseReleased(e);
				break;
		default:
			break;
